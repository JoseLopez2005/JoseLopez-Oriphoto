            ...
            .map(produit => (
                `
                    <li class="produit-item"><a href="produit.html">
                        ...
                        <button onclick="window.open('http://127.0.0.1:5501/produit.html', '_self')" class="produit-item__bouton" id="btn">Plus de détails</button>
                    </a></li>
                `           
                )
            ).join('')
            ...
            .map(cameras => (
                `
                    <li class="cameras-item">
                        ...
                        <button onclick="window.open('http://127.0.0.1:5501/produit.html', '_self')" class="cameras-item__bouton" id="btn">Ajouter au panier</button>
                    </li>
                `           
                )
            ).join('')
...
showCameras(firstCamera.slice[0]);